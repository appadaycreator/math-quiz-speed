...
const SVC_URL = "https://appadaycreator.com/math-quiz-speed/";
const SVC_NAME = "算数・数学クイズゲーム";

test.describe("算数・数学クイズゲーム - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("math-quiz-speed");
